...
def build_privacy():
    ...
    body = crumb + ('<section class="section"><div class="shell legal-shell">'
        ...
        '<p>This site uses minimal cookies and local storage to remember preferences such as your theme choice, and privacy-respecting analytics to understand how the site is used. We use Google Analytics 4 (provided by Google) for aggregate traffic statistics, and Microsoft Clarity (provided by Microsoft) for anonymised usage insights such as heatmaps and session replays of on-page interactions. These tools may collect information such as pages visited, approximate location, and device and browser type; they are used to understand aggregate usage and improve the site, not to identify you personally. Google and Microsoft process this data as third parties under their own privacy terms. You can control, clear or block these cookies through your browser settings; some features may not work without them.</p>'
