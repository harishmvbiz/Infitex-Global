...
# ---------------------------------------------------------------- section nav (home)
def section_nav():
    items = [("Who we help", "#who"), ("Stack", "#stack"), ("How it works", "#how"),
...
def build_home():
    hero = ('<section class="hero hero-grid" id="top"><div class="shell"><div class="hero-inner">'
        ...
        '<p class="hero-sub" data-tw>INFITEX is the back office behind Australian accounting practices and the finance team behind Australian businesses — from bookkeeping and payroll through to management reporting and Virtual CFO. Native to Xero, XPM, MYOB and the tools you already use.</p>'
        ...
        '<a class="path-chip" href="outsourcing.html"><b>For practices</b> — white-label</a>'
        '<a class="path-chip" href="industry.html"><b>For business</b> — finance &amp; Virtual CFO</a>'
        '<a class="path-chip" href="digitech.html"><b>Digitech</b> — web &amp; SEO</a></div>'
        '</div>'
        '<div class="console term-card"><div class="term-bar"><i></i><i></i><i></i><span style="margin-left:8px;font-family:var(--font-mono);font-size:.74rem;color:var(--muted)">infitex — prepare</span></div>'
        '<div class="term-body" id="heroConsole"></div></div>'
        '</div></div></section>')
    ...
    body = (hero + section_nav() + s_stack + s_who + s_div + s_how + s_eng + s_out + s_sec
            + s_dig + s_calc + s_test + s_dates + s_about + s_faq + s_pilot
...
def build_outsourcing():
    ...
    body = crumb + hero + s_scope + s_cycle + s_sec + s_test + s_cta
...
def build_sitemap_html():
    ...
    groups = [
        ...
        ("Home sections", [("Software stack", "index.html#stack"), ("Divisions", "index.html#divisions"),
                           ("How it works", "index.html#how"), ("Engagement models", "index.html#engagement"),
